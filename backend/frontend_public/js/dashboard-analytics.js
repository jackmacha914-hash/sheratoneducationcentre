...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    const [userCount, clubCount, bookCount, feeCount, eventCount] = await Promise.all([
        fetchCount('https://sheratoneducationcentre.onrender.com/api/users'),
        fetchCount('https://sheratoneducationcentre.onrender.com/api/clubs'),
        fetchCount('https://sheratoneducationcentre.onrender.com/api/library'),
        fetchCount('https://sheratoneducationcentre.onrender.com/api/fees'),
        fetchCount('https://sheratoneducationcentre.onrender.com/api/events'),
    ]);
