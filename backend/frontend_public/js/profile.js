...
if (typeof API_BASE_URL === 'undefined') {
    window.API_BASE_URL = 'https://sheratoneducationcentre.onrender.com';
}
...
<<<<<<< HEAD
        photoUrl = photoUrl.replace(/^http:\/\/localhost(:\d+)?/, window.API_CONFIG?.BASE_URL || 'https://sheratoneducationcentre.onrender.com');
=======
...
<<<<<<< HEAD
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://sheratoneducationcentre.onrender.com'}${data.profile.photo}`;
          } else if (!data.profile.photo.startsWith('http')) {
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://sheratoneducationcentre.onrender.com'}/uploads/${data.profile.photo}`;
=======
...
async function changePassword() {
  ...
  try {
<<<<<<< HEAD
    const response = await fetch("https://sheratoneducationcentre.onrender.com/api/profile/change-password", {
=======
